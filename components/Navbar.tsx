...
export default function Navbar({ activeTab, onTabChange }: NavbarProps) {
  ...
  return (
    <nav className="bg-background/80 border-b border-border/40 sticky top-0 z-50 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 shadow-sm">
      <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        >
          <button
            ...
            className={`w-20 py-1.5 text-sm font-semibold rounded-full transition-all ${
              activeTab === 'single'
